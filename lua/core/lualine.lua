...
ins_left {
	function()
		...
		return vim.fn.empty(file) == 1 and "" or vim.bo.modified and "" or vim.bo.readonly and "" or ""
	end,
	color = function()
		local file = vim.fn.expand "%:t"
		return {
...
ins_left {
	...
	color = function()
		...
		return {
			gui = "bold",
			fg = vim.fn.empty(file) == 1 and colors.fg or vim.bo.modified and colors.red or colors.fg,
		}
	end,
}
